...
public class CreateCampaignWithStatusTest {
	public static void main(String[] args) throws IOException {
		...
		String CAMPAIGN_NAME = eLib.readDataFromExcel("Campaign", 4, 2);
		String STATUS = eLib.readDataFromExcel("Campaign", 4, 3);
		String TARGET_SIZE = eLib.readDataFromExcel("Campaign", 4, 4);
