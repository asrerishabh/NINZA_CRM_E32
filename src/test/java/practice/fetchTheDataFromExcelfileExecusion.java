...
public class fetchTheDataFromExcelfileExecusion {
...
//	WebDriverManager.edgedriver().setup(); 
 ...
 // create campaign
	...
	campaignName.sendKeys("campaign");// campaign from excel--not hardcoded
	 
	WebElement targetSize = driver.findElement(By.name("targetSize"));
	targetSize.clear();
	targetSize.sendKeys("targetsize");//targetsize fromexcel
